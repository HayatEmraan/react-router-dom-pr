...
const Expense = () => {
  const handleForm = (e) => {
    ...
    toast.success("Opps! Your Expense has been submitted!");
  };
  return (
        ...
        <div className="-mx-3 md:flex mb-6">
          <div className="md:w-full px-3">
            ...
            <input
              ...
              type="text"
              name="jobName"
              placeholder="your reason for expense"
              required
            />
          ...
          <div className="md:w-1/2 px-3">
            ...
            <div className="relative">
              ...
              >
                ...
                <option value={"Buying a bike"}>Buying a bike</option>
                <option value={"Buying a laptop"}>Buying a laptop</option>
